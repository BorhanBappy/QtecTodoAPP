...
function App() {
  ...
  return (
    ...
    >
      <div className="bg-[#172842] min-h-screen w-full py-8 text-lg">
        <div className="w-full max-w-2xl mx-auto shadow-md rounded-lg px-4 py-3 text-white">
          ...
          <div className="flex flex-col gap-6 justify-center items-center md:items-start md:flex-row ">
            <div className=" w-1/2">
              <h2 className="text-lg font-bold mb-2 text-center">
                Incomplete Tasks
              </h2>
              <Priority Todo={incompleteTodos} />
            </div>
            <div className="w-1/2">
              <h2 className="text-lg font-bold mb-2 text-center">
                Completed Tasks
